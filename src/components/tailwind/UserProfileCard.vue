    ...
    <div class="relative rounded-[8px] border-[1px] bg-white">
        ...
        <div class="flex flex-col justify-center items-center w-full -translate-y-[1.5rem]">
            ...
            <div class="flex flex-row w-full mt-[1rem]">
                ...
                <div class="w-1/3 flex flex-col gap-1 justify-center items-center"><div class="font-bold">3.5M</div><div>订阅他的</div></div>
                <div class="w-1/3 flex flex-col gap-1 justify-center items-center"><div class="font-bold">200</div><div>他的订阅</div></div>
            </div>
        </div>
    </div>
</template>
