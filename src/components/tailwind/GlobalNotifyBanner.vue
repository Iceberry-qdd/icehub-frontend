...
const state = reactive({
    msgPack: props.message,
    msgTypeMap: new Map([['SYS_NOTIFY_INFO', 'bg-info'], ['SYS_NOTIFY_SUCCESS', 'bg-success'], ['SYS_NOTIFY_WARNING', 'bg-warning'], ['SYS_NOTIFY_ERROR', 'bg-error'], ['SYS_NOTIFY_ACTIVITY', 'bg-activity'], ['SYS_NOTIFY_PLAIN', 'bg-plain']])
})
