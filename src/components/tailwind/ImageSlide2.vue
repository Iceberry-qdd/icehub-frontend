        ...
        <div class="flex absolute flex-col w-screen h-screen items-center justify-center">
            <div
                ...
                <img
                    ...
                    class=" min-h-[25rem] min-w-[25rem] max-h-screen max-w-screen"
                    :src="url.previewUrl"/>
            </div>
        </div>
        <div
            ...
            class="absolute bottom-3 left-1/2 -translate-x-1/2 bg-[#000000BB] rounded-full p-2 cursor-pointer">
            <IconAltOn class="w-[1.2rem] h-[1.2rem]"></IconAltOn>
        </div>
        <div
            @mouseleave="state.showAlt = false"
            v-if="state.showAlt && state.imgs[state.activeIndex].altText"
            class="absolute bottom-3 left-1/2 -translate-x-1/2 text-white text-[11pt] leading-[1.5rem] text-justify break-words bg-[#000000AA] px-4 py-3 rounded-[8px] break-all">
