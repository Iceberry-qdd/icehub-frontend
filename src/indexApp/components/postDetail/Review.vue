            ...
            <Teleport to="#app" :disabled="!store.MOBILE_MODE">
                ...
                <Transition name="fade">
                    <UserInfoPop
                        ...
                        class="absolute h-fit max-sm:fixed max-sm:left-0 max-sm:w-screen max-sm:z-[1001] sm:top-4 user-info-pop w-[20rem] z-[98]"
                        ...
                        <Teleport to="#app" :disabled="!store.MOBILE_MODE">
                            ...
                            <Transition name="fade">
                                <ReviewMenu
                                    ...
                                    class="absolute bottom-0 h-auto max-sm:fixed max-sm:left-0 max-sm:rounded-b-none max-sm:rounded-t-[0.75rem] max-sm:w-screen max-sm:z-[1000] review-menu rounded-[8px] sm:max-w-[18rem] sm:min-w-[10rem]"
                                    :review="state.review">
                                </ReviewMenu>
                            </Transition>
                        </Teleport>
