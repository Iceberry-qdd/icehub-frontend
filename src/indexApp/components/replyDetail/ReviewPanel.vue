<template>
    <div
        ...
        @click.self="dismiss">
        <div class="bg-white dark:bg-[#121212] max-sm:h-[calc(100dvh-2.5rem-env(safe-area-inset-bottom,0px)+7px)] max-sm:rounded-none modern-scrollbar-y overflow-y-auto rounded-[8px] sm:max-h-[80%] sm:min-h-[20%] sm:w-[36rem]">
            <Header
