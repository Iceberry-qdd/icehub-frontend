<template>
    <div
        id="passkey-create-dialog"
        class="bg-[#00000066] fixed-page flex flex-row h-screen items-center justify-center max-sm:items-end max-sm:z-[1001] sm:backdrop-blur-sm w-screen z-[111]"
        @click.self="close">
        <div
            class="bg-white dark:bg-[#1e1e1e] fade-in flex flex-col flex-nowrap gap-y-[1rem] h-[30rem] items-center justify-between max-h-full max-sm:h-[50dvh] max-sm:rounded-b-none modern-scrollbar-y overflow-y-auto p-4 pk-inner rounded-[8px] w-[25rem]">
