    ...
    <Header
        ...
        <Transition name="fade">
            <div
                ...
                id="search-suggest"
                class="-translate-x-2 bg-white border-[1px] dark:bg-neutral-900 dark:border-neutral-800 divide-y fixed flex flex-col max-h-[min(24rem,75vh)] modern-scrollbar-y overflow-y-auto rounded-[8px] shadow-md text-base top-[50px] w-[calc(100%-1rem)] z-[105]">
