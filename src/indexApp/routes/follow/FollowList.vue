...
import { getUserInfoByNickname, getFollowList } from '@/indexApp/js/api.js'
...
async function getFollower() {
    ...
    try {
        ...
        const response2 = await getFollowList(id, state.pageIndex, state.pageSize, state.lastTimestamp)
