...
import { getLikeListOfPost } from '@/indexApp/js/api.js'
...
async function fetchLikeUserList() {
    try {
        ...
        const response = await getLikeListOfPost(props.post.id, state.pageIndex, state.pageSize, state.lastTimestamp)
