...
export const store = reactive({
    ...
    setCDB(dialogBox) {
        this.CONFIRM_DIALOG_BOX = dialogBox
    },
    resetCDB() {
        this.CONFIRM_DIALOG_BOX = {
            show: false,
            title: 'title',
            confirmButton: {
                text: 'confirm',
    ...
    showCDB() {
        this.CONFIRM_DIALOG_BOX.show = true
    },
    startCDBLoading() {
        this.CONFIRM_DIALOG_BOX.loading.show = true
    },
    stopCDBLoading(){
        this.CONFIRM_DIALOG_BOX.loading.show = false
    },
    selectCDBConfirmButton() {
        this.CONFIRM_DIALOG_BOX.confirmButton.selected = true
        this.CONFIRM_DIALOG_BOX.cancelButton.selected = false
    },
    selectCDBCancelButton(){
        this.CONFIRM_DIALOG_BOX.confirmButton.selected = false
        this.CONFIRM_DIALOG_BOX.cancelButton.selected = true
    }
})